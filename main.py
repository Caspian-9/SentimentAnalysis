...
class App:
    ...
    def __init__(self) -> None:
        ...
        for i in range(6):
            ...
            self.image_list.append(Image(55, 0, img_name))
    ...
    def run(self) -> None:
        ...
        while self.running:
            ...
            self.draw_image(self.image_list[self.state], screen)
...
# OLD APP CLASS FOR REFERENCE. DO NOT CHANGE
# class App:
#     """
#     Manager class of our app.
...
#     image_1 = Image(55, 0, 'graphs/graph0_2.png')
#     image_2 = Image(55, 0, 'graphs/graph1_2.png')
#     image_3 = Image(55, 0, 'graphs/graph2_2.png')
#     image_4 = Image(55, 0, 'graphs/graph3_2.png')
#     image_5 = Image(55, 0, 'graphs/graph4_2.png')
#     font: pygame.font.SysFont
...
#         self.font = pygame.font.SysFont('Corbel', 24)
#         # generate graphs
#         g.generate_graph(0, 2)
#         g.generate_graph(1, 2)
#         g.generate_graph(2, 2)
#         g.generate_graph(3, 2)
#         g.generate_graph(4, 2)
